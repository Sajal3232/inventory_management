      ...
      <!--card-header -->
            <div id="form_body" class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="custom-bg">
                    <form action="{{url('/editor/advanced_salary/update')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="row">
                        <input type="hidden" name="hidden_id"  value="{{$advancedsalary->id}}">
                        <div class="col-sm-12">
                            <div class="form-group">
                              <label>Employee <span>*</span></label>
                              <?php $employess=App\Models\Employee::all();?>
                      ...
                      <!-- /.form-group -->
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="year" class="form-control{{ $errors->has('year') ? ' is-invalid' : '' }}" value="{{$advancedsalary->year}}">
                      ...
                      <!-- /.form-group -->
                        <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="advanced_salary" class="form-control{{ $errors->has('advanced_salary') ? ' is-invalid' : '' }}" value="{{ $advancedsalary->advanced_salary}}">
