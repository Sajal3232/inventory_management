      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Manage Employee</h3> <a href="{{url('/editor/employee/add')}}" class="btn btn-primary addsellerp">Add New</a>
          </div>
          <!-- /.card-header -->
                    ...
                    <td>
                      <ul class="action_buttons dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            @endif
                            <li>
                                <a class="edit_icon" href="{{url('editor/employee/edit/'.$value->id)}}" title="View Details" ><i class="fa fa-edit"></i> Edit</a>
                            </li>
                            <li>
                                <a class="edit_icon" href="{{url('editor/employee/delete/'.$value->id)}}" title="View Details" ><i class="fa fa-trash"></i> Delete</a>
                            </li>
